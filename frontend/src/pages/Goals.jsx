    ...
    <section className="card goal-card">
      <div className="goal-card-head">
        ...
        <div className="goal-actions">
          ...
          <button className="icon-btn danger" onClick={() => onDelete((goal._id ?? goal.id)?.toString())} aria-label="Delete goal">
            <Trash2 size={15} />
          </button>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <Modal open={openForm} title="New Goal" onClose={() => setOpenForm(false)}>
        ...
        />
        {submitting && <p style={{ textAlign: 'center', color: '#64748b', marginTop: 8 }}>Saving…</p>}
      </Modal>
