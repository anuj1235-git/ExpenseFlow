...
export default function TransactionDetailModal({ transaction: rawT, onClose, onEdit, onDelete }) {
  if (!rawT) return null;

  // Normalise _id → id so the rest of this component is id-agnostic
  const t = { ...rawT, id: rawT.id ?? rawT._id?.toString() };
